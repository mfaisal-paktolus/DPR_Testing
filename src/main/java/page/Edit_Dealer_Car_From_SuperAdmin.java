...
public class Edit_Dealer_Car_From_SuperAdmin extends BaseLibrary
{

	public Edit_Dealer_Car_From_SuperAdmin()
	{
	...
	{
		Thread.sleep(1000);
		visibility_Of_Element(Search_Car, "223544");
	...
	public void Edit_Car_Details() throws InterruptedException
	{
		...
		Enter_Vin.clear();
		Thread.sleep(1000);
		visibility_Of_Element(Enter_Vin, "12345QAZXSW");
